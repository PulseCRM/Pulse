...
namespace LP2Service
{
    internal class InfoHubService : ServiceBase
    {
        ...
        static string myServiceName = string.Empty;
        public InfoHubService()
        {
            ...
            string tempServiceName = ConfigurationManager.AppSettings.Get("ServiceName");
            this.ServiceName = string.IsNullOrEmpty(tempServiceName) ? InfoHubEventLog.LogSource : tempServiceName.Trim();
