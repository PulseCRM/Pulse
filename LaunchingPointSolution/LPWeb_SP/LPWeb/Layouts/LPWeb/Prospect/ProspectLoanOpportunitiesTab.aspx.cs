...
public partial class ProspectLoanOpportunitiesTab : BasePage
{
    int iLoanID = 0;
    ...
    public string OrderName
    {
        get
        {
            if (ViewState["orderName"] == null)
                ViewState["orderName"] = "LienPosition";
    ...
    protected void ddlActiveLeads_SelectedIndexChanged(object sender, EventArgs e)
    {
        BindGrid(1);
    }
}
