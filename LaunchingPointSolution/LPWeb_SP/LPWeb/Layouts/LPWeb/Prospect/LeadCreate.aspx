...
<%@ Page Title="Create Lead" Language="C#" AutoEventWireup="true" CodeBehind="LeadCreate.aspx.cs"
    Inherits="Prospect_LeadCreate" MasterPageFile="~/_layouts/LPWeb/MasterPage/Pipeline.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainArea" runat="Server">
    <div id="divLeadContainer" class="margin-top-10 margin-bottom-20">
            ...
            <div id="tabs-3">
                <table cellpadding="3" cellspacing="3">
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- <asp:Image ID="imgRanking" runat="server" ImageUrl="../images/prospect/Hot.gif" /> -->
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            Status:
                            <asp:Label ID="lbStatus" runat="server" Text="Active"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <a id="aSelectContact" href="javascript:aSelectContact_onlick()" class="ui-icon ui-icon-search"
                                style="position: relative; top: -19px; left: 165px;">&nbsp;&nbsp;&nbsp;&nbsp;</a>
            ...
            <div id="tabs-4">
                <table cellpadding="3" cellspacing="3">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlProgram" runat="server" DataValueField="LoanProgram" DataTextField="LoanProgram"
                                Width="184px">
                            </asp:DropDownList>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlProgramNewLoan" runat="server" DataValueField="LoanProgram"
                                DataTextField="LoanProgram" Width="184px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTerm" runat="server" Width="70px" MaxLength="3"></asp:TextBox>
                            months
                        </td>
                        <td>
                            Term:
                        ...
                        <td>
                            <asp:TextBox ID="txtTermNewLoan" runat="server" Width="70px" MaxLength="3"></asp:TextBox>
                            months
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            Amount($):&nbsp;&nbsp;<asp:TextBox ID="txt2ndAmount" runat="server" MaxLength="15"
                                class="dollar-text" Style="width: 135px; padding-left: 12px;"></asp:TextBox>
                        </td>
                        <td>
                ...
                <table cellpadding="3" cellspacing="3">
                    ...
                    <tr>
                        ...
                        <td id="tdMonthlySalary" style="width: 250px;">
                            <asp:TextBox ID="txtMonthlySalary" runat="server" MaxLength="8" class="dollar-text"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                        ...
                        <td style="padding-left: 30px;">
                            <table cellpadding="3" cellspacing="3">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtComments" runat="server" TextMode="MultiLine" Style="height: 150px;
                                            overflow: auto;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <div class="margin-top-20">
            <asp:Button ID="btnSaveGoToDetail" runat="server" Text="Save and Go to Lead Detail"
                CssClass="Btn-160" OnClientClick="return BeforeSave()" OnClick="btnSaveGoToDetail_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnCreateAnother" runat="server" Text="Save and Create Another" CssClass="Btn-160"
                OnClientClick="return BeforeSave()" OnClick="btnCreateAnother_Click" />
        </div>
    </div>
