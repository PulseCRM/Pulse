...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeadSetupTab.aspx.cs" Inherits="LeadSetupTab" %>
...
// <![CDATA[
         ...
         function SetSrc(src) {
             ...
             if (src.indexOf("LoanDetailsTask.aspx") != -1 || src.indexOf("LoanDetailsAlertTab.aspx") != -1) {
                 ...
                 src = src + "?sid=" + RadomStr + "&FileID=" + FileID + "&ref=lead";
             }
             return src
         }
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <div id="tabs10">
                            <ul>
                                <li id="current"><a href="" onclick="SetTab('ProspectLoanContactTab.aspx',0);return false;"><span>Contacts</span></a></li>
                                <li><a href="" onclick="SetTab('../LoanDetails/WorkflowSetupTab.aspx',1);return false;"><span>Workflow Setup</span></a></li>                              
                               
                                <li><a id="" href="" onclick="SetTab('../LoanDetails/LoanDetailsRuleSetupTab.aspx',2);return false;"><span>Rule Setup</span></a></li>
                                <li><a id="" href="" onclick="SetTab('ProspectLoanStageTab.aspx',3);return false;"><span>Stage Setup</span></a></li>
                                <li><a href="" onclick="SetTab('PointInfoTab.aspx',4);return false;"><span>Point Info</span></a></li>
