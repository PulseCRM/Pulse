...
public partial class Prospect_LeadEdit : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((CurrUser.userRole == null) || string.IsNullOrEmpty(CurrUser.userRole.Prospect) ||
          !(CurrUser.userRole.Prospect.ToUpper().Contains("B")))
        {
    ...
    private bool SaveLead(out int iReturnFileId) 
    {
        ...
        if (this.sActionMode == "Edit_HasLoanId_NoContactId" || this.sActionMode == "Edit_HasContactId_HasLoan")
        {
            ...
            if (this.CoBorrowerInfo_Contact == null)    // create co-borrower
            {
                ...
                this.ContactMgr.LinkCoBorrowerToLoan(iCurrentLoanId, iCoBorrowerID);
            ...
            else
            {
                ...
                iCoBorrowerID = Convert.ToInt32(this.CoBorrowerInfo_Contact.Rows[0]["ContactId"]);
            ...
            if (bCreateNewLoan == true)
            {
                ...
                try
                {
                    iNewFileID = this.CreateLoan(iBorrowerID, iCoBorrowerID, sHousingStatus, sRentAmount, sPropertyStreetAddress1, sPropertyStreetAddress2, sPropertyCity, sPropertyState, sPropertyZip, sPropertyValue,
