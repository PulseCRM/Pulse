...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProspectLoanArchivedTab.aspx.cs"
    Inherits="ProspectLoanArchivedTab" %>
    ...
    <div id="divGrid" class="ColorGrid" style="width: 900px; margin-top: 5px; margin-left: 10px;">
        <asp:GridView ID="gvLoans" runat="server" CssClass="GrayGrid" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Status" SortExpression="Status" HeaderStyle-Width="100">
                    <ItemTemplate>
                        <%# Eval("Status")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Point File " SortExpression="Name" ItemStyle-Wrap="false">
                    <ItemTemplate>
                    <a id="aBorrower" href="javascript:GoToLoanDetails('<%# Eval("FileID") %>')"
                            class="<%# Eval("FileID") %>">                            
                        <%# Eval("Name")%> </a>
                    </ItemTemplate>
                </asp:TemplateField>
