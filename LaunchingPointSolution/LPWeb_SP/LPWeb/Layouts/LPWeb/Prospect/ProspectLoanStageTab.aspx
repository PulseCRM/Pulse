...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProspectLoanStageTab.aspx.cs"
    Inherits="ProspectLoanStageTab" %>
    ...
    <div style="padding-left: 10px; padding-right: 10px;">
        <div id="divToolBar" style="margin-top: 13px;">
            <table cellpadding="0" cellspacing="0" border="0" style="width: 700px;">
                <tr>
                    <td colspan="2">
                        Target Close Date:&nbsp;&nbsp;<asp:TextBox ID="tbxTargetCloseDate" CssClass="DateField"
                ...
                <tr>
                    <td colspan="2">
                        Date Created:&nbsp;&nbsp;<asp:Label ID="lbDateCreated" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
