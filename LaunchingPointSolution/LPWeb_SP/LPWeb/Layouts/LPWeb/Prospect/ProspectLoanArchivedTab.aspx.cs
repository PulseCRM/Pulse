...
public partial class ProspectLoanArchivedTab : BasePage
{
    int iLoanID = 0;
    ...
    private void BindGrid(int pageIndex)
    {
        try
        {
            ...
            int recordCount = 0;
            DataSet ds = loan.GetProspectArchivedLoans(pageSize, pageIndex, " Contactid=" + CurrentContactID.ToString(), out recordCount, OrderName, OrderType);
