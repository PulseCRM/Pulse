...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmploymentIncomeTab.aspx.cs" Inherits="EmploymentIncomeTab" %>
...
<body style="width: 700px">
    ...
    <div id="divLeadContainer" class="margin-top-10 margin-bottom-20">
        ...
        <div id="tabs">
            <%--<ul style="height:60px;" style="display:none;" >
            ...
            <div id="tabs-4" style=" display:none;">
                ...
                <table cellpadding="3" cellspacing="3">
                    ...
                    <tr>
                        <td>Rate:</td>
                        <td>
                            <span style="position:absolute; top:223px; left:141px;">%</span><asp:TextBox ID="txtRate" runat="server" MaxLength="10" class="percent-text"></asp:TextBox>
                        </td>
                        <td>Rate:</td>
                        <td>
                            <span style="position:absolute; top:223px; left:514px;">%</span><asp:TextBox ID="txtRateNewLoan" runat="server" MaxLength="10" class="percent-text"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>Monthly PMI:</td>
            ...
            <div id="tabs-5" style="margin-top: 10px;">
        ...
        <div class="margin-top-20">
            <asp:Button ID="btnSaveGoToDetail" runat="server" Text="Save" CssClass="Btn-66" OnClientClick="return BeforeSave()" OnClick="btnSaveGoToDetail_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
