...
{
    public partial class Billing : LayoutsPageBase
    {
        ...
        protected void btnAddBalance_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    PageCommon.RegisterJsMsg(this, "Please enter the amount.", "");
                    return;
                }
                ...
                using (LP2ServiceClient client = sm.StartServiceClient())
                {
                    ...
                    if (rsp.hdr.Successful)
                    {
                        ...
                        PageCommon.RegisterJsMsg(this, "Add Balance Successfully.", "");
                    }
                    else
                    {
                        PageCommon.RegisterJsMsg(this, rsp.hdr.StatusInfo, "");
                    }
                }
            }
            catch (Exception ex)
