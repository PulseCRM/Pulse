...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectMarketingCampaign.aspx.cs" Inherits="SelectMarketingCampaign"  %>
            ...
            <div id="divMarketingCampaignList" class="ColorGrid">
                <asp:GridView ID="gridMarketingCampaignList" DataKeyNames="CampaignId" runat="server" EmptyDataText="There is no Marketing Campaign." AutoGenerateColumns="False" CellPadding="3" CssClass="GrayGrid" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CategoryName" ControlStyle-Width="200px" HeaderText="Category" />
                        <asp:BoundField DataField="CampaignName" ControlStyle-Width="200px" HeaderText="Marketing Campaign" />
                    </Columns>
                </asp:GridView>
