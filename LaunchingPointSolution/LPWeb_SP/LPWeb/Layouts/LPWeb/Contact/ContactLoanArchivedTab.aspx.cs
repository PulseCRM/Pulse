...
public partial class ContactLoanArchivedTab : BasePage
{
    int iLoanID = 0;
    ...
    public string OrderName
    {
        get
        {
            if (ViewState["orderName"] == null)
                ViewState["orderName"] = "BorrowerName";
    ...
    private void BindGrid(int pageIndex)
    {
        try
        {
            ...
            int recordCount = 0;
            DataSet ds = loan.GetPartnerContactArchivedLoans(pageSize, pageIndex, " Contactid=" + CurrentContactID.ToString(), out recordCount, OrderName, OrderType);
