...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartnerServiceTypeSetup.aspx.cs"
    Inherits="LPWeb.Layouts.LPWeb.Contact.PartnerServiceTypeSetup" MasterPageFile="~/_layouts/LPWeb/MasterPage/Contact.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainArea" runat="Server">
    <div id="divModuleName" class="ModuleTitle">
        Partner Service Type Setup</div>
    <div class="SplitLine">
    </div>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="padding-left: 15px;">
                        <asp:TextBox ID="txtServiceType" runat="server" class="iTextBox" Style="width: 240px;"
    ...
    <div id="div1" class="ColorGrid" style="margin-top: 5px; width: 420px;">
        <asp:GridView ID="gvSerivceType" runat="server" DataKeyNames="ServiceTypeId" EmptyDataText="There is no service type in database."
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Name" SortExpression="Name" HeaderText="Service Type" />
