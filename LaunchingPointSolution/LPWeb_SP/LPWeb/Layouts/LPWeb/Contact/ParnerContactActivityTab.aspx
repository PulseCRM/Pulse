...
<%@ Page Title="Activity History List" Language="C#" AutoEventWireup="true" Inherits="ParnerContactActivityTab"
    CodeBehind="ParnerContactActivityTab.aspx.cs" %>
...
<body>
    ...
    <div style="padding-left: 10px; padding-right: 10px;">
        ...
        <div id="div2" class="ColorGrid" style="margin-top: 5px;">
            <asp:GridView ID="gridList" runat="server" DataKeyNames="ContactActivityId" EmptyDataText="There is no data in database."
