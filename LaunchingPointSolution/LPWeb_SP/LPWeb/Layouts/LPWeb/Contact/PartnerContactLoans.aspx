...
<%@ Page Language="C#"  
    ...
    Inherits="PartnerContactLoans" 
    CodeBehind="PartnerContactLoans.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            DrawTab();
            SetTab("ContactLoanOpportunitiesTab.aspx", 0);
        });
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <div id="tabs10">
                            <ul>
                                <li id="current"><a href="#" onclick="SetTab('ContactLoanOpportunitiesTab.aspx',0);return false;">
                                    <span>Leads</span></a></li>
                                <li><a href="#" onclick="SetTab('ContactLoanActiveTab.aspx',1);return false;"><span>
                                    Active Loans</span></a></li>
                                <li><a href="#" onclick="SetTab('ContactLoanArchivedTab.aspx',2);return false;"><span>
                                    Archived Loans</span></a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
