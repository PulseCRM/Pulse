...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskEdit.aspx.cs" Inherits="LoanDetails_TaskEdit" %>
...
<body>
    ...
    <div id="divContainer" class="margin-top-10">
                        ...
                        <td>
                            ...
                            <table cellpadding="3" cellspacing="3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTaskName" runat="server" Width="160px" MaxLength="255"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Due Date:</td>
            ...
            <div id="tabs-2">
                ...
                <div class="margin-top-10">
                    ...
                    <div id="divLoanTask_CompletionEmails" class="ColorGrid margin-top-5">
                        <asp:GridView ID="gridCompletetionEmails" runat="server"  OnRowDataBound="gridCompletetionEmails_RowDataBound"
                            EmptyDataText="There is no Completion Emails." AutoGenerateColumns="False" CellPadding="3" CssClass="GrayGrid" GridLines="None">
        ...
        <div class="margin-top-20">
            ...
            &nbsp;&nbsp;
            <asp:Button ID="btnAddtoOutlook" runat="server" Text="Add to Outlook" CssClass="Btn-115" OnClick="btniCalendarExport_Click" />
            &nbsp;&nbsp;
