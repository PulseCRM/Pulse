...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanActions.aspx.cs" Inherits="LPWeb.Layouts.LPWeb.LoanDetails.LoanActions" %>
...
<div class="JTab" style="margin-top: 10px; width:1020px">
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <div id="tabs10">
                            <ul>
                                <li id="current"><a href="" onclick="SetTab('LoanDetailsTask.aspx',0);return false;"><span>Tasks</span></a></li>
                                <li><a href="" onclick="SetTab('LoanConditions.aspx',1);return false;"><span>Conditions</span></a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
            ...
            <div id="TabBody">
                ...
                <div class="TabContent">
                    <iframe id="tabFrame" frameborder="0" style="border: solid 0px blue; height: 582px;
                        width: 1000px; overflow:hidden;" scrolling="no" onload="Javascript:SetWinHeight(this)" ></iframe>
                </div>
            </div>
        </div>
