...
public partial class LoanDetails_EmailSendCompletionWindowOpen : BasePage
{
    int iLoanID = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        bIsValid = PageCommon.ValidateQueryString(this, "LoanTaskId", QueryStringType.ID);
        if (bIsValid == false)
        {
            this.ClientScript.RegisterStartupScript(this.GetType(), "_InvalidQuery2", sErrorJs, true);
            return;
        }
        this.iTaskID = Convert.ToInt32(this.Request.QueryString["LoanTaskId"]);
