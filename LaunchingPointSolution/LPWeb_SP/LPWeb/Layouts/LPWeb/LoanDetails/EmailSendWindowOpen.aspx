...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailSendWindowOpen.aspx.cs" Inherits="LoanDetails_EmailSendWindowOpen" %>
...
<body>
    ...
    <div id="divContainer" style="width: 600px;" class="AlignCenter">
        <div id="divModuleName" class="ModuleTitle">Send Email</div>
        <div class="SplitLine" style="margin-top: 3px;"></div>
        ...
        <div id="divRecipientList" class="ColorGrid" style="margin-top: 3px;">
            <div>
