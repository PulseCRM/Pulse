...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanContactsTab.aspx.cs"
    Inherits="LoanContactsTab" %>
    ...
    <script type="text/javascript">
        ...
        function getUpdatePage(ContactID) {
            ...
            if (checkedIds1[0].indexOf("Borrower") > -1 || checkedIds1[0].indexOf("CoBorrowe") > -1) {
                ...
                var iFrameSrc = "../Prospect/ProspectDetailPopup.aspx?sid=" + RadomStr + "&ProspectID=" + ContactID + "&CloseDialogCodes=window.parent.CloseGlobalPopup()&RefreshCodes=window.parent.RefreshLoanDetailInfo()&RefreshTab=window.parent.parent.parent.RefreshContactsTab()";
                ...
                var iFrameSrc = "../Contact/PartnerContactsSetupPopup.aspx?sid=" + RadomStr + "&ContactID=" + ContactID + "&CloseDialogCodes=window.parent.parent.parent.CloseGlobalPopup()&RefreshCodes=window.parent.RefreshLoanDetailInfo()&RefreshTab=window.parent.parent.parent.RefreshContactsTab()";
        ...
        function LoanReassign(userandrole) {
            ...
            var iFrameSrc = "ReassignLoan.aspx?FileID=" + fileId + "&uandr=" + userandrole + "&sid=" + radomStr + "&CloseDialogCodes=window.parent.parent.parent.CloseGlobalPopup()";
        ...
        function ContactReassign(userandrole) {
            ...
            var iFrameSrc = "LoanReassignContactTab.aspx?FileID=" + fileId + "&uandr=" + userandrole + "&sid=" + radomStr + "&CloseDialogCodes=window.parent.parent.parent.CloseGlobalPopup()";
        ...
        function ShowDialog_SendEmail() {
            ...
            var RadomNum = Math.random();
            var RadomStr = RadomNum.toString().substr(2);
            //            $("#ifrSendEmail").attr("src", "EmailSendPopup.aspx?sid=" + RadomStr + "&LoanID=" + LoanID);
            ...
            var iFrameSrc = "EmailSendPopup.aspx?sid=" + RadomStr + "&LoanID=" + LoanID + "&CloseDialogCodes=window.parent.parent.parent.CloseGlobalPopup()";
        ...
        //CR43 SendNowWithattAchments
        function ShowDialog_SendNowWithattAchments() {
            ...
            var ContactIDs = checkedIds;
            var LoanID = GetQueryString1("FileID");
            var RadomNum = Math.random();
            var RadomStr = RadomNum.toString().substr(2);

            var iFrameSrc = "SendNowWithAttachments.aspx?sid=" + RadomStr + "&LoanID=" + LoanID + "&ContactIDs=" + ContactIDs + "&CloseDialogCodes=window.parent.parent.parent.RefreshContactsTab();window.parent.parent.parent.CloseGlobalPopup()";
            ...
            window.parent.parent.ShowGlobalPopup("Send LSR Now with Attachments", iFrameWidth, iFrameHeight, divWidth, divHeight, iFrameSrc)
        ...
        function BeforePreview() {
            ...
            // show waiting
//            window.parent.parent.ShowWaitingDialog3("Preview Report...");
            ...
            if (checkedIds[0].indexOf("User") > -1) {
                UserID = checkedIds.pop().replace(/User/, "");
                ContactID = "0";
            }
            else {
                ContactID = checkedIds.pop().replace(/Contract/, "");
                UserID = "0";
            }

            OpenWindow("LSRPreview.aspx?sid=" + sid + "&FileId=" + iLoanID + "&ContactId=" + ContactID + "&UserId=" + UserID, "_Preview", 760, 580, "no", "center");
                ...
                if (data.ExecResult == "Failed") {
                    ...
                    if (data.ErrorMsg != "") {
                        ...
                        if ($.browser.msie == true) {   // ie
                            ...
                            p = "window.parent.document.frames[window.parent.idivIndex].document.frames['tabFrame'].AssignLoanContact";
                        }
                        else {   // firefox

                            p = "window.parent.document.getElementById(window.parent.document.getElementsByTagName('iframe')[window.parent.idivIndex].id).contentDocument.getElementById('tabFrame').contentWindow.AssignLoanContact";
                        }

                        var iFrameSrc = "AssignLoanContactPopup.aspx?sid=" + sid + "&FileID=" + FileID + "&GetIDsFunction=" + p + "&CloseDialogCodes=window.parent.parent.CloseGlobalPopup()";
                ...
                if (data.ExecResult == "Failed") {
                    ...
                    if (data.ErrorMsg != "") {
                        ...
                        if ($.browser.msie == true) {   // ie
                            ...
                            p = "window.parent.document.frames[window.parent.idivIndex].document.frames['tabFrame'].AssignLoanTeam";
                        }
                        else {   // firefox

                            p = "window.parent.document.getElementById(window.parent.document.getElementsByTagName('iframe')[window.parent.idivIndex].id).contentDocument.getElementById('tabFrame').contentWindow.AssignLoanTeam";
                        }

                        var iFrameSrc = "AssignLoanTeamPopup.aspx?sid=" + sid + "&FileID=" + FileID + "&GetIDsFunction=" + p + "&CloseDialogCodes=window.parent.parent.CloseGlobalPopup()";
...
<body style="width: 700px">
    ...
    <div id="divGrid" class="ColorGrid" style="width: 1000px; margin-top: 5px; margin-left: 10px;">
        <asp:GridView ID="gvContacts" runat="server" CssClass="GrayGrid" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Type" SortExpression="ContactRole" HeaderStyle-Width="100">
                    <ItemTemplate>
                        <%# Eval("ContactRole")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Company" SortExpression="CompanyName" HeaderStyle-Width="200px"
                    ItemStyle-Wrap="false">
                    <ItemTemplate>
                        <%# Eval("CompanyName")%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText=" Phone" SortExpression="BusinessPhone" ItemStyle-Wrap="false">
                    <ItemTemplate>
                        <%# Eval("BusinessPhone")%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Cell " SortExpression="CellPhone" ItemStyle-Wrap="false">
                    <ItemTemplate>
                        <%# Eval("CellPhone")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Status Report" SortExpression="StatusReport" ItemStyle-Wrap="false">
                    <ItemTemplate>
                        <%# Eval("StatusReport")%>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <ul id="divDisposeMenu" class="jqcontextmenu">
        <li>
            <asp:LinkButton ID="lbtnPreview" runat="server" OnClientClick="return BeforePreview();">Preview</asp:LinkButton></li>
        <li>
        ...
        <li>
            <asp:LinkButton ID="lbtnSendNowWithattAchments" runat="server" OnClientClick="ShowDialog_SendNowWithattAchments(); return false;" >Send Now with attachments</asp:LinkButton></li>
        <li>
