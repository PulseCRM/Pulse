...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanContactAdd.aspx.cs"
    Inherits="LoanContactAdd" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function btnCancel_onclick() {
            ...
            window.parent.DialogContactAddClose();
        }
            ...
            <div style="margin-top: 9px;">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="ckEnable" Text=" Enable" Checked="true" runat="server" />
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div style="margin-top: 9px;">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="width: 250px;">
                            <asp:DropDownList ID="ddlState" runat="server" Width="50px" Height="16px">
                              </asp:DropDownList>
                        </td>
                        <td style="width: 100px; padding-left: 10px;">
                            Zip :
