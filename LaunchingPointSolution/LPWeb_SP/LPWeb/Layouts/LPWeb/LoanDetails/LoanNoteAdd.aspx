...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoanNoteAdd.aspx.cs" Inherits="LPWeb.Layouts.LPWeb.LoanDetails.LoanNoteAdd" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $().ready(function () {
            ...
            var myDate = new Date();
            $("#<%=hfLocalTime.ClientID %>").val(myDate.getFullYear() + "-" + (myDate.getMonth() + 1) + "-" + myDate.getDate() + " " + myDate.getHours() + ":" + myDate.getMinutes() + ":" + myDate.getSeconds());
        });
...
<body>
    ...
    <div id="divDetail">
        ...
        <table class="detail">
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBox ID="cbExternalViewing" runat="server" />External Viewing
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:TextBox style="color:black; background-color:white;" ID="tbxNote" MaxLength="500" runat="server" TextMode="MultiLine" Rows="5"
    ...
    <asp:HiddenField ID="hfLocalTime" runat="server" />
