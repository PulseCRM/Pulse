...
<%@ Page Title="Archived Pipeline Summary" Language="C#" MasterPageFile="~/_layouts/LPWeb/MasterPage/Pipeline.master"
    AutoEventWireup="true" CodeBehind="ArchivedPipelineSummary.aspx.cs" Inherits="Pipeline_ArchivedPipelineSummary" %>
        ...
        $(document).ready(function () {
            ...
            $("#<%= btnRemove.ClientID %>").click(function () {
                if ($("#<%=hfDeleteItems.ClientID %>").val() == "") {
                    ...
                    return confirm("This will delete all the loan records, workflow history and activities.Are you sure you want to continue?");
                }
            });
            ...
            //                    if (s == "closed") {
            //                        $("*", menu).remove();
            //                        alert("You cannot resume a closed loan.");
            //                        return menu;
            //                    }
            //                    if (s == "processing") {
            //                        $("#resume", menu).remove();
            ...
            //                    alert("hiSelectedLoan.ClientID=" + $("#" + '<%=hiSelectedLoan.ClientID %>').val());
...
//        }
        ...
        function resumeLoan()
        {
           ...
           var LoanId = $("#<%=hfDeleteItems.ClientID %>").val();
            $("#"+'<%=hiSelectedLoan.ClientID %>').val(LoanId);
            $("#"+'<%=hiSelectedDisposal.ClientID %>').val('Processing');
            tLS= 1;
            ShowFolerSelWin();
        }

        function getFolderSelectionReturn(sReturn,sType)
        {
            $("#"+'<%=hiSelectedFolderId.ClientID %>').val(sReturn);
            $('#dialog1').dialog('close');
            if(sType!=null && sType=='1')
            {
                <%=this.ClientScript.GetPostBackEventReference(this.btnResume, null) %>
            }
            else
            {
        ...
        function onSearchClick() {
            var f = document.getElementById('iframeImportErrorList1');
            f.src = "SearchLoans.aspx?type=archived&t=" + Math.random().toString();
       ...
       function closeSearchWin() {
        ...
        if (allSelectedLoan.length > 1) {
            ...
            $("#"+'<%=hiSelectedDisposal.ClientID %>').val('move');
             var f = document.getElementById('iframePF');
            f.src = "PointFolderSelection.aspx?fid=" +  $("#" + '<%=hiSelectedLoan.ClientID %>').val() + "&tls="+  $("#" + '<%=hiSelectedLoanStatus.ClientID %>').val() +"&bid=" + bId + "&t=" + Math.random().toString();
            $('#dialog1').dialog('open');
            return false;
        }
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <div id="tabs10">
                            <ul>
                                <li><a href="ProspectPipelineSummary.aspx"><span>Opportunities</span></a></li>
                                <li><a href="ProcessingPipelineSummary.aspx"><span>Active Loans</span></a></li>
                                <li id="current"><a href="ArchivedPipelineSummary.aspx"><span>Archived Loans</span></a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
                ...
                <div class="TabContent">
                        ...
                        <div id="divFilter" style="margin-top: 15px;">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="padding-left: 15px;">
                                        <asp:DropDownList ID="ddlStatus" runat="server" DataTextField="Name" DataValueField="StageId">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 600px;">
                                        <ul class="ToolStrip">
                                            ...
                                            <li>
                                                <asp:LinkButton ID="btnResume" runat="server" Text="Resume" OnClick="btnResume_Click"
                                                    OnClientClick="resumeLoan();return false;"></asp:LinkButton><span>|</span></li>
                                            <li>
                                           ...
                                           <li><asp:LinkButton ID="btnMove" OnClientClick="onMoveClick();return false;" runat="server"  Text="Move File"></asp:LinkButton><span>|</span></li>
                                            <li><asp:LinkButton ID="btnSearch" runat="server" Text="Search" OnClientClick="onSearchClick(); return false;"></asp:LinkButton><span>|</span></li>
                        ...
                        <asp:GridView ID="gvPipelineView" runat="server" CssClass="GrayGrid" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Status" SortExpression="Status" ItemStyle-Wrap="false"
                                 ...
                                 <asp:TemplateField HeaderText="<div style='text-align: center;'>Alerts<div>" SortExpression="RateLockIcon"
                    ...
                    <div style="display: none;">
                        ...
                        <div id="dialogPointImportErrorList1">
                            <iframe id="iframeImportErrorList1" name="iframeImportErrorList1" frameborder="0" width="100%"
                                height="100%"></iframe>
                        </div>
