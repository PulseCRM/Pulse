...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportRegionProduction.aspx.cs"
    Inherits="LPWeb.Reports.ReportRegionProduction" %>
...
<body>
    ...
    <div id="ReportContainer">
        ...
        <div id="divDivision" class="ColorGrid" style="margin-top: 5px;">
            <asp:GridView ID="gvRegionReport" runat="server" CssClass="GrayGrid" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Region" SortExpression="RegionName" ItemStyle-Wrap="false"
                        ItemStyle-Width="120" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <%# Eval("RegionName")%>
                        </ItemTemplate>
                    </asp:TemplateField>
