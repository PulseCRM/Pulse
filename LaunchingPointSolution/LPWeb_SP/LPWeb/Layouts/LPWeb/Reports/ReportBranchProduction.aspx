...
<%@ Page Title="Branch Production Goals Report" Language="C#" AutoEventWireup="true"
    CodeBehind="ReportBranchProduction.aspx.cs" Inherits="LPWeb.Reports.ReportBranchProduction" %>
...
<body>
    ...
    <div id="ReportContainer">
        ...
        <div id="divDivision" class="ColorGrid" style="margin-top: 5px;">
            <asp:GridView ID="gvBranchReport" runat="server" CssClass="GrayGrid" AutoGenerateColumns="false"
                Width="100%" AllowSorting="true" EmptyDataText="There is no data in database."
                OnSorting="gvBranchReport_Sorting" CellPadding="3" GridLines="None">
                <EmptyDataRowStyle CssClass="EmptyDataRow" HorizontalAlign="Center" />
                <AlternatingRowStyle CssClass="EvenRow" />
                <Columns>
                    <asp:TemplateField HeaderText="Branch" SortExpression="BranchName" ItemStyle-Wrap="false"
                        ItemStyle-Width="120">
                        <ItemTemplate>
                            <%# Eval("BranchName")%>
                        </ItemTemplate>
