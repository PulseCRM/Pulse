...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkflowTemplateClone.aspx.cs" Inherits="LPWeb.Layouts.LPWeb.Settings.WorkflowTemplateClone" %>
...
// <![CDATA[
        ...
        $(document).ready(function () {
            ...
            //#region DaysFromEstClose txtDaysAfterCreationDate
            ...
            if (CalcMethod == "Completion Date of the previous Stage") {
                TmpCalcMethod = "3";
            }
        ...
        function CallPostBack() {
            ...
            var WflStageIDs = "";
            $("#gridStageList tr td :checkbox[id='chkChecked']").each(function (i) {

                var WflStageId = $(this).attr("tag");
                if (i == 0) {
                    WflStageIDs = WflStageId;
                }
                else {
                    WflStageIDs += "," + WflStageId;
                }
...
<body>
            ...
            <table style="margin-top: 2px;">
                <tr>
                    ...
                    <td style="width: 170px; vertical-align: top;">
                        <asp:DropDownList ID="ddlCalcDueDateMethod" runat="server" Width="250px" Enabled="true">
                ...
                <asp:GridView ID="gridStageList" runat="server" EmptyDataText="There is no stage, please add." AutoGenerateColumns="False" CellPadding="4" CssClass="GrayGrid" GridLines="None">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderStyle-CssClass="CheckBoxHeader" ItemStyle-CssClass="CheckBoxColumn">
                            ...
                            <ItemTemplate>
                                <input id="chkChecked" type="checkbox" tag='<%# Eval("WflStageId") %>'/>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Enabled" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Tasks" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a id="aTaskCount" href="javascript:aUpdateStage_onclick()"><%# Eval("TaskCount") %></a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
    ...
    <div id="divHiddenFields" style="display: none;">
        ...
        <asp:TextBox ID="hdnCalculationMethod" runat="server"></asp:TextBox>
