...
<%@ Page Title="Email Template List" Language="C#" MasterPageFile="~/_layouts/LPWeb/MasterPage/Settings.master"
    AutoEventWireup="true" CodeBehind="CompanyTaskPickList.aspx.cs" Inherits="Settings_CompanyTaskPickList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/common.js" type="text/javascript"></script>
     ...
     <script language="javascript" type="text/javascript">
         var gridId = "#<%=gvTaskName.ClientID %>";
         $(document).ready(function () {
             DrawTab();

             $("#<%= gvTaskName.ClientID %>").tablesorter({
             ...
             $("#<%= btnDisable.ClientID %>").click(function () {
                 if ($("#<%=hfDeleteItems.ClientID %>").val() == "") {
                     alert("Please select an item to disable.");
                     return false;
                 }
                 else {
                     return confirm("Disable selected item(s)?");
                 }
             });

             $("#<%= btnEnable.ClientID %>").click(function () {
                 if ($("#<%=hfDeleteItems.ClientID %>").val() == "") {
                     alert("Please select an item to enable.");
                     return false;
                 }
                 else {
                     return confirm("Enable selected item(s)?");
                 }
             });
         });
         ...
         function BeforeSave() {
             ...
             if (TaskName == null && typeof (TaskName) == "undefined" && TaskName == "") {
                 ...
                 var Pattern = /^[a-zA-Z0-9_\s-]{1,255}$/;
                 var IsValid = Pattern.test(TaskName);
                 if (IsValid == false) {

                     alert("Please enter a task name consisting alphanumeric characters, spaces, hyphens and underscores.");
                     return false;
                 }
             }
             ...
             // required
             //var SequenceNumber = $.trim($("#txtSequenceNumber").val());
             var SequenceNumber = document.getElementById("<%=txtSequenceNumber.ClientID%>").value;
             if (SequenceNumber != null && typeof (SequenceNumber) != "undefined" && SequenceNumber != "") {

                 if (/^[0-9]*[1-9][0-9]*$/.test(SequenceNumber)) {//这个正则表达式为整数                         
                     if (SequenceNumber >= 32767) {
                         alert("Sequence number must be between 1 - 30000.");

                         return false;
                     }
                 }
                 else {
                     alert("Sequence number must be a positive number.");

                     return false;
                 }
             }
             else {
                 alert("Sequence number is not specified.");
                 return false;
             }
    ...
    <div class="JTab" style="margin-top:10px;">
                    ...
                    <td>
                        <div id="tabs11">
                            <ul>
                                ...
                                <li id="Li1"><a href="CompanyTaskPickList.aspx"><span>Leads</span></a></li>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
            <tr>
                ...
                <td>
                    <div id="tabs10">
                        <ul>
                            <li id="current"><a href="CompanyTaskPickList.aspx"><span>Task Pick List</span></a></li>
                            <li><a href="CompanyLeadSources.aspx"><span>Lead Sources</span></a></li>
                            <li><a href="CompanyLeadStatus.aspx"><span>Lead Status</span></a></li>
                        </ul>
                    </div>
        ...
        <div id="TabBody">
                ...
                <tr>
                    <td>Task Name：</td>
                    <td>
                         <asp:TextBox ID="txtTaskName" runat="server" Text="" Width="200" MaxLength="255"></asp:TextBox>
                    </td>
                    <td style="width: 50px;"></td>
                    <td>Sequence Number：</td>
                    <td>
                         <asp:TextBox ID="txtSequenceNumber" runat="server" Text="" Width="50" MaxLength="5"></asp:TextBox>
                    </td>
                 ...
                 <tr>
                            <td height="20" colspan="2" style="padding-top: 9px; padding-bottom: 9px;">
                                <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="Btn-66" OnClick="btnAdd_Click"  OnClientClick="return BeforeSave()"/>
                            </td>
                        </tr>
            </table>
                        ...
                        <tr>
                            <td colspan="2">
                                <div id="divDivision" class="ColorGrid" style="width: 760px; margin-top: 5px;">
                                    <asp:GridView ID="gvTaskName" runat="server" CssClass="GrayGrid tablesorter" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-CssClass="CheckBoxHeader" ItemStyle-CssClass="CheckBoxColumn"
                                                ...
                                                <ItemTemplate>
                                                    <input type="checkbox" tag='<%# Eval("TaskName") %>' />
                                                </ItemTemplate>
                                                <AlternatingItemTemplate>
                                                    <input type="checkbox" tag='<%# Eval("TaskName") %>' />
                                                </AlternatingItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="TaskName" HeaderStyle-CssClass="CheckBoxHeader"
                                            ...
                                            <asp:TemplateField HeaderText="Enabled" HeaderStyle-CssClass="CheckBoxHeader" HeaderStyle-Width="100px">
                                             ...
                                             <asp:TemplateField HeaderText="Sequence Number" HeaderStyle-CssClass="CheckBoxHeader" HeaderStyle-Width="130px">
                                                <ItemTemplate>
                                                    <itemtemplate><%# Eval("SequenceNumber")%></itemtemplate>
                                                </ItemTemplate>
                                                <AlternatingItemTemplate>
                                                     <itemtemplate><%# Eval("SequenceNumber")%></itemtemplate>
                                                </AlternatingItemTemplate>
