...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkflowTaskTemplateEdit.aspx.cs" Inherits="Settings_WorkflowTaskTemplateEdit" %>
...
// <![CDATA[
        ...
        function ddlStage_onchange() {
            ...
            window.location.href = "WorkflowTaskTemplateEdit.aspx?TemplateID=" + TemplateID + "&StageID=" + StageID + "&TaskID=" + TaskID;
        }
...
//                        return true;
        ...
        function BeforeClone() {
            ...
            var TaskName1 = $.trim($("#txbTaskName1").val());
            $("#tbxTaskName").val(TaskName1);
...
<body>
    ...
    <div id="divContainer" style="border: solid 0px red;">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="padding-left: 8px;">
                        <input id="btnClone" type="button" value="Clone" class="Btn-66" onclick="btnClone_onclick()"/>
                    </td>
                    <td style="padding-left: 8px;">
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" class="Btn-66" OnClientClick="return DeleteTask()" OnClick="btnDelete_Click" />
                    </td>
                    <td style="padding-left: 8px;">
        ...
        <div id="divDetails" style="margin-top: 10px;">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 310px;">
                        <asp:TextBox ID="txtSequence" runat="server" Width="100px" MaxLength="3"></asp:TextBox>
                    </td>
        ...
        <div id="divCmpltEmailList">
            ...
            <div id="divStageList" class="ColorGrid" style="width: 550px; margin-top: 3px;">
                <asp:GridView ID="gridCompletionEmailList" runat="server" EmptyDataText="There is no completion email template, please add." AutoGenerateColumns="False" CellPadding="4" CssClass="GrayGrid" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Email Template">
                            <ItemTemplate>
                                <select name="ddlCmpltEmailTmplt<%# Eval("RowIndex") %>" id="ddlCmpltEmailTmplt<%# Eval("RowIndex") %>" style="width:350px;">
                                    <%# this.GetOptions_ddlCmpltEmailTmplt(Eval("TemplEmailId").ToString())%>
                                </select>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Enabled" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <input id="chkEnabled" type="checkbox" <%# Eval("Enabled").ToString() == "False" ? "" : "checked" %> />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a id="aPreview" href="javascript:PreviewCompletionEmail('<%# Eval("TemplEmailId") %>')" style="text-decoration: underline;">Preview</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
    ...
    <div id="divNewTaskName" title="Enter Workflow Template Name" style="display: none; margin: 10px;">
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txbTaskName1" runat="server" MaxLength="255" Width="250px"></asp:TextBox>
                </td>
            </tr>
        </table>
        <br />
        <div style="text-align: center;">
            <input id="btnCreate" type="button" value="Create" class="Btn-66" onclick="BeforeClone()" />
            <asp:Button ID="btnClone1" runat="server" Text="Clone" CssClass="Btn-66" OnClick="btnClone1_Click" style="display:none;" />
            &nbsp;&nbsp;
