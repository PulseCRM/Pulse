...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailTemplateCloneParent.aspx.cs" Inherits="Settings_EmailTemplateCloneParent" MasterPageFile="~/_layouts/LPWeb/MasterPage/Settings.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var iFrameSrc = "EmailTemplateClone.aspx?sid=" + sid + "&EmailTemplateID=" + EmailTemplateID;
