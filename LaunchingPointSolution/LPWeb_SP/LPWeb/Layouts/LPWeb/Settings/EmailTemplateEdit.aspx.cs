...
public partial class Settings_EmailTemplateEdit : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        bool bIsRef = this.EmailTemplateManager.bIsRef(this.iEmailTemplateID);
        this.hdnIsRef.Text = bIsRef.ToString();
        ...
        if (this.IsPostBack == false)
        {
            ...
            this.txtEmailTemplateName.Text = EmailTemplateInfo.Rows[0]["Name"].ToString();
            ...
            this.txtDesc.Text = EmailTemplateInfo.Rows[0]["Desc"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        bool bIsExist = this.EmailTemplateManager.IsExist_Edit(this.iEmailTemplateID, sEmailTemplateName);
        if (bIsExist == true)
        {
            this.ClientScript.RegisterClientScriptBlock(this.GetType(), "_Duplicate", "$('#divContainer').hide();alert('The email template name is used by other template, please change anther one.');$('#divContainer').show()", true);
            return;
        }
        ...
        this.EmailTemplateManager.UpdateEmailTemplate(this.iEmailTemplateID, sEmailTemplateName, this.chkEnabled.Checked, sDesc, iFromUserRoleID, sUserDefinedEmail, sBody, sSubject, sEmailList_To, sUserRoleIDs_To, sContactRoleIDs_To, sEmailList_CC, sUserRoleIDs_CC, sContactRoleIDs_CC, sTaskOwnerChecked_To, sTaskOwnerChecked_CC, chkLeadCreated.Checked, sSenderName, iEmailSkinID);

        PageCommon.WriteJsEnd(this, "Update email template successfully.", "window.parent.location.href = 'EmailTemplateList.aspx';");
    }
    ...
    {
        this.EmailTemplateManager.DeleteEmailTemplate(this.iEmailTemplateID);

        PageCommon.WriteJsEnd(this, "Delete email template successfully.", "window.parent.location.href = 'EmailTemplateList.aspx';");
    }
