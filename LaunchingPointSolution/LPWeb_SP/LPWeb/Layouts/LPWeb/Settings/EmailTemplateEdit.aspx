...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailTemplateEdit.aspx.cs" Inherits="Settings_EmailTemplateEdit" ValidateRequest="false" %>
...
// <![CDATA[
        ...
        $(document).ready(function () {
            ...
            var src = "EmailTemplateAttachmentList.aspx?EmailTemplateID=" + EmailTemplateID;
        ...
        function AddValidators() {
            ...
            $("#form1").validate({
                ...
                messages: {
                    ...
                    txtFromEmail: {
                        email: "<div>Please enter valid email address.</div>"
                    }
                }
            });
        }
        ...
        function BeforeSave() {
            ...
            if (FromUserRole == "0" && UserDefinedEmail == "") {
                ...
                alert("Please select a From role or enter User-defined Email.");
                $("#tabs").tabs("select", 0);
                return false;
            }
        ...
        function BeforeDelete() {
            ...
            if (IsRef == "True") {
                ...
                var r1 = confirm("The Email Template has been referenced by other records. Deleting it will remove all the references and may cause email notifications to stop working. Are you sure you want to continue?");
                if (r1 == false) {
        ...
        function btnClone_click() {
            ...
            window.parent.location.href = "EmailTemplateCloneParent.aspx?sid=" + sid + "&EmailTemplateID=" + EmailTemplateID;
        }
        ...
        function btnPreview_onclick() {
            ...
            OpenWindow("EmailTemplatePreview.aspx?id=" + EmailTemplateID, "_PreviewEmailTemplate2", 760, 700, "no", "center");
        ...
        <div style="margin-top: 20px;">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="padding-left: 8px;">
                        <input id="btnClone" type="button" value="Clone" class="Btn-66" onclick="btnClone_click()" />
                    </td>
                    <td style="padding-left: 8px;">
                                    ...
                                    <asp:GridView ID="gridToList" runat="server" EmptyDataText="There is no recipient." AutoGenerateColumns="False" CellPadding="3" CssClass="GrayGrid" GridLines="None">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-CssClass="CheckBoxHeader" ItemStyle-CssClass="CheckBoxColumn">
                                                ...
                                                <ItemTemplate>
                                                    <input type="checkbox" myRoleType="<%# Eval("Type") %>" myRoleID="<%# Eval("RoleID") %>" myEmail="<%# Eval("Email") %>" myRoleName="<%# Eval("RoleName") %>" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                        <tr>
                            <td style="width: 260px; vertical-align: top;">
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="width: 185px;">Previous value of Point Field:</td>
                                        <td>
                                            <input id="btnInsert_Preview" type="button" value="Insert" onclick="btnInsert_Preview_onclick()" style="border: none; background-color: White;" />
                                        </td>
                                    </tr>
                                </table>
                                <div>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="width: 185px;">Current value of Point Field:</td>
                                        <td>
                                            <input id="btnInsert_Current" type="button" value="Insert" onclick="btnInsert_Current_onclick()" style="border: none; background-color: White;" />
                                        </td>
                                    </tr>
                                </table>
                                <div>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="width: 185px;">Pulse database field:</td>
                                        <td>
                                            <input id="btnInsert_InfoHub" type="button" value="Insert" onclick="btnInsert_InfoHub_onclick()" style="border: none; background-color: White;" />
                                        </td>
                                    </tr>
                                </table>
                                <div>
                                    <asp:DropDownList ID="ddlInfoHubFields" runat="server">
                                        ...
                                        <asp:ListItem>Company Email</asp:ListItem>
                                        <asp:ListItem>Company Fax</asp:ListItem>
                                        <asp:ListItem>Company Phone</asp:ListItem>
                                        ...
                                        <asp:ListItem>Branch Email</asp:ListItem>
                                        <asp:ListItem>Branch Fax</asp:ListItem>
                                        <asp:ListItem>Branch Phone</asp:ListItem>
                                        <asp:ListItem>Branch Website</asp:ListItem>
                                        <asp:ListItem>Closer Cell</asp:ListItem>
                                        <asp:ListItem>Closer Fax</asp:ListItem>
                                        <asp:ListItem>Closer Phone</asp:ListItem>
                                        <asp:ListItem>Doc Prep Cell</asp:ListItem>
                                        <asp:ListItem>Doc Prep Fax</asp:ListItem>
                                        <asp:ListItem>Doc Prep Phone</asp:ListItem>
                                        <asp:ListItem>Loan Officer Cell</asp:ListItem>
                                        <asp:ListItem>Loan Officer Fax</asp:ListItem>
                                        <asp:ListItem>Loan Officer Phone</asp:ListItem>
                                        <asp:ListItem>Loan Officer Assistant Cell</asp:ListItem>
                                        <asp:ListItem>Loan Officer Assistant Fax</asp:ListItem>
                                        <asp:ListItem>Loan Officer Assistant Phone</asp:ListItem>
                                        ...
                                        <asp:ListItem>Processor Cell</asp:ListItem>
                                        <asp:ListItem>Processor Fax</asp:ListItem>
                                        <asp:ListItem>Processor Phone</asp:ListItem>
                                        ...
                                        <asp:ListItem>Underwriter Cell</asp:ListItem>
                                        <asp:ListItem>Underwriter Fax</asp:ListItem>
                                        <asp:ListItem>Underwriter Phone</asp:ListItem>
                                        ...
                                        <asp:ListItem>Shipper Cell</asp:ListItem>
                                        <asp:ListItem>Shipper Fax</asp:ListItem>
                                        <asp:ListItem>Shipper Phone</asp:ListItem>
                            ...
                            <td>
                                ...
                                <telerik:RadEditor ID="RadEditor1" runat="server" ContentAreaMode="Div" OnClientLoad="OnClientLoad" NewLineMode="P" Width="700px" Height="600px" EditModes="Design,Html">
                                    <Modules>
            ...
            <div id="divRecipientRoleList" class="ColorGrid" style="width: 508px;">
                <asp:GridView ID="gridRecipientRoleList" runat="server" EmptyDataText="There is no user roles/contact roles." AutoGenerateColumns="False" CellPadding="3" CssClass="GrayGrid" GridLines="None">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderStyle-CssClass="CheckBoxHeader" ItemStyle-CssClass="CheckBoxColumn">
                            <HeaderTemplate>
                                <input type="checkbox" onclick="CheckAll_RecipientRoleList(this)" />
                            </HeaderTemplate>
                            <ItemTemplate>
                                <input type="checkbox" myRoleType="<%# Eval("RecipientType") %>" myRoleID="<%# Eval("RoleID")%>" myRoleName="<%# Eval("RecipientRole")%>" />
                            </ItemTemplate>
                        </asp:TemplateField>
