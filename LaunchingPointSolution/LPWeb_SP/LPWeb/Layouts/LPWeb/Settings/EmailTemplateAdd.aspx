...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailTemplateAdd.aspx.cs"
    Inherits="Settings_EmailTemplateAdd" ValidateRequest="false" %>
...
// <![CDATA[
        ...
        function BeforeSave() {
            ...
            if (FromUserRole == "0" && UserDefinedEmail == "") {
                ...
                alert("Please select a From role or enter a User-defined Email Address.");
                $("#tabs").tabs("select", 0);
                return false;
            }
            ...
            if ($("#gridToList tr td :checkbox").length == 0) {
                ...
                alert("Please add a To recipient.");
                $("#tabs").tabs("select", 0);
                return false;
            }
        ...
        function btnPreview_onclick() {
            ...
            OpenWindow("EmailTemplatePreview.aspx?html=" + encodeURIComponent(HtmlBody_Encode), "_PreviewEmailTemplate2", 760, 700, "no", "center");
...
// ]]>
                ...
                <div id="tabs-General">
                    ...
                    <table cellpadding="0" cellspacing="0" style="margin-top: 9px;">
                        <tr>
                            ...
                            <td style="width: 350px;">
                                <asp:DropDownList ID="ddlFromUserRoles" runat="server" Width="200px" DataValueField="RoleID"
                                    DataTextField="Name">
                                </asp:DropDownList>
                            </td>
                    ...
                    <table cellpadding="0" cellspacing="0" style="margin-top: 9px;">
                        <tr>
                            ...
                            <td style="vertical-align: top;" rowspan="2">
                                <div id="divToList" class="ColorGrid" style="margin-top: 5px; width: 303px;">
                                    <asp:GridView ID="gridToList" runat="server" EmptyDataText="There is no recipient."
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Email" HeaderText="Email/Role" />
                                        </Columns>
                                    </asp:GridView>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; padding-top: 5px;">
                                    ...
                                    <asp:GridView ID="gridCCList" runat="server" EmptyDataText="There is no recipient."
                                        AutoGenerateColumns="False" CellPadding="3" CssClass="GrayGrid" GridLines="None">
                                        <EmptyDataRowStyle CssClass="EmptyDataRow" HorizontalAlign="Center" />
                                        <AlternatingRowStyle CssClass="EvenRow" />
                                        <Columns>
                                            <asp:BoundField DataField="Type" HeaderText="Type" ItemStyle-Width="50px" />
                                            <asp:BoundField DataField="EmailOrRole" HeaderText="Email/Role" />
                                        </Columns>
                                    </asp:GridView>
                                    <div class="GridPaddingBottom">&nbsp;</div>
                                </div>
    ...
    <div id="divEmailRecipientSelection" title="Email Recipient Selection" style="display: none;">
        ...
        <div style="margin-top: 15px; width: 528px; height: 420px; overflow: auto; border-bottom: solid 1px #e4e7ef;">
            <div id="divRecipientRoleList" class="ColorGrid" style="width: 508px;">
                <asp:GridView ID="gridRecipientRoleList" runat="server" EmptyDataText="There is no user roles/contact roles."
                    AutoGenerateColumns="False" CellPadding="3" CssClass="GrayGrid" GridLines="None">
                    <EmptyDataRowStyle CssClass="EmptyDataRow" HorizontalAlign="Center" />
                    <AlternatingRowStyle CssClass="EvenRow" />
                    <Columns>
                        <asp:TemplateField HeaderStyle-CssClass="CheckBoxHeader" ItemStyle-CssClass="CheckBoxColumn">
                            ...
                            <ItemTemplate>
                                <input id="Checkbox2" type="checkbox" myroletype="<%# Eval("RecipientType") %>" myroleid="<%# Eval("RoleID")%>"
                                    myrolename="<%# Eval("RecipientRole")%>" />
                            </ItemTemplate>
                        </asp:TemplateField>
