...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkflowTemplateAdd.aspx.cs" Inherits="LPWeb.Layouts.LPWeb.Settings.WorkflowTemplateAdd" %>
...
<body>
    ...
    <div id="divContainer" style="width: 985px; height: 698px;">
                    ...
                    <td style="width: 175px;">
                        <table cellpadding="0" cellspacing="0" style="position: relative; top: -5px;">
                            <tr>
                                ...
                                <td style="padding-left: 3px;"><label for="chkDefault">Default</label></td>
                            </tr>
                        </table>
